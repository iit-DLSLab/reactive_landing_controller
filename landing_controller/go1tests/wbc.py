# This script tests the wbc in base_controllers.quadruped_controller
# To map wrenches into grfs, you cau use either the 'projection' method or the 'qp' one (this second requires to call setWBCConstraints first)
...
test['profile'] = True
test['profiler_filename'] = os.environ['LOCOSIM_DIR'] + '/landing_controller/go1tests/stats_wbc.cprof'
...
if __name__ == '__main__':
    ...
    try:
        ...
        if test['profile']:
            ps = pstats.Stats(pr)
            ps.dump_stats(test['profiler_filename'])
